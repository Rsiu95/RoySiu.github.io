...
reps = 0
timer = None
file_path = "./Udemy 100 Days of Code/Day 28/tomato.png"
...
def start_timer():
    ...
    if reps == 8:
        ...
        #checkmark_label.config(text = "✓" * reps)
...
# checkmark
checkmark_label = Label(font = (FONT_NAME, 16, "bold"), fg = GREEN, bg = YELLOW, highlightthickness = 0)
